...
class ECGDataset(Dataset):
    def __init__(self, base_img_paths, style_img_paths, phase='train'):
        ...
        self.phase = phase
        path_data_ch1 = loadmat('trainmats/clear_sig.mat')
        label = loadmat('trainmats/noisy_sig.mat')
        ...
        self.data=np.zeros((1,int(len(self.data_ch1)),32000))
        self.data2=np.zeros((1,int(len(self.label)),32000))
